...
var changeTurn = function changeTurn() {
  // this function returns either x or o by shortening the turns array with shift(). alternating starting with o.
  var whosTurn = '';
...
var checkWin = function checkWin() {
  if (marks[0] === marks[1] && marks[1] === marks[2] && marks[0] !== 0) {
    ...
    return marks[6] + ' wins!';
  } else if (marks[0] === marks[3] && marks[3] === marks[6] && marks[0] !== 0) {
    // vertical wins
    return marks[0] + ' wins!';
    ...
    return marks[2] + ' wins!';
  } else if (marks[0] === marks[4] && marks[4] === marks[8] && marks[0] !== 0) {
    // diagonal wins
    return marks[0] + ' wins!';
...
var onUpdateGame = function onUpdateGame(event) {
  var data = store.gameState;
  api.updateGame(data).then(ui.updateGameSuccess).catch(ui.updateGameFailiure);
};

var onShowGames = function onShowGames(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.showGames(data).then(ui.showGamesSuccess).catch(ui.showGamesFailiure);
};
...
var updateGameFailiure = function updateGameFailiure(data) {
...
var showGamesFailiure = function showGamesFailiure(data) {
...
module.exports = {
  ...
  updateGameFailiure: updateGameFailiure,
  showGamesSuccess: showGamesSuccess,
  showGamesFailiure: showGamesFailiure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
